...
initial_null.beta = repmat([table2array(tmp(strcmp(tmp.Name, '(Intercept)'), 2)), table2array(tmp(strcmp(tmp.Name, 'ages_1'), 2)), table2array(tmp(strcmp(tmp.Name, 'ages_2'), 2)), table2array(tmp(strcmp(tmp.Name, 'ages_4'), 2))], 6, 1);
...
initial_null.Bcraw_r4 = initial_null.Bcraw_r1;
initial_null.Bcraw_r5 = initial_null.Bcraw_r1;
initial_null.Bcraw_r6 = initial_null.Bcraw_r1;
