...
initial_sat.beta = repmat([table2array(tmp(strcmp(tmp.Name, '(Intercept)'), 2)), table2array(tmp(strcmp(tmp.Name, 'ages_1'), 2)), table2array(tmp(strcmp(tmp.Name, 'ages_2'), 2)), table2array(tmp(strcmp(tmp.Name, 'ages_4'), 2))], 3, 1);
